class AssetsManager {
  ...
  static const String headSebhaDark = "${base}head_sebha_dark.png";
  static const String headSebhaLight = "${base}head_sebha_logo.png";
  static const String bodySebhaDark = "${base}body_sebha_dark.png";
  static const String bodySebhaLight = "${base}body_sebha_logo.png";
}
